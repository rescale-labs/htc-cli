...
// Encode encodes HTCJobFailureCode as json.
func (o NilHTCJobFailureCode) Encode(e *jx.Encoder) {
	if o.Null {
		e.Null()
		return
	}
...
// Decode decodes HTCJobFailureCode from json.
func (o *NilHTCJobFailureCode) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode NilHTCJobFailureCode to nil")
	}
	if d.Next() == jx.Null {
...
// MarshalJSON implements stdjson.Marshaler.
func (s NilHTCJobFailureCode) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *NilHTCJobFailureCode) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes NullableInstant as json.
func (s NullableInstant) Encode(e *jx.Encoder) {
	unwrapped := time.Time(s)

	json.EncodeDateTime(e, unwrapped)
}

// Decode decodes NullableInstant from json.
func (s *NullableInstant) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode NullableInstant to nil")
	}
	var unwrapped time.Time
	if err := func() error {
		v, err := json.DecodeDateTime(d)
	...
	*s = NullableInstant(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s NullableInstant) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *NullableInstant) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
func (o *OptJobStatusSummaryJobStatuses) Decode(d *jx.Decoder) error {
	...
	o.Set = true
	o.Value = make(JobStatusSummaryJobStatuses)
	if err := o.Value.Decode(d); err != nil {
		return err
	}
	return nil
...
// Decode decodes NullableInstant from json.
func (o *OptNilNullableInstant) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptNilNullableInstant to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptNilNullableInstant) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptNilNullableInstant) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
