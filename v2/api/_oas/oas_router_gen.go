						...
						case '/': // Prefix: "/"
							...
							case 'd': // Prefix: "dimensions"
								...
								if len(elem) == 0 {
									...
									case "PUT":
										s.handleCreateProjectDimensionsRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									default:
													...
													case '/': // Prefix: "/"
														...
														case 'e': // Prefix: "events"
															...
															if len(elem) == 0 {
																...
																switch r.Method {
																case "GET":
																	s.handleGetEventsRequest([3]string{
																		args[0],
																		args[1],
																		args[2],
																	}, elemIsEscaped, w, r)
											...
											case 's': // Prefix: "s"
												...
												case 'u': // Prefix: "ummary-statistics"
													...
													if len(elem) == 0 {
														...
														switch r.Method {
														case "GET":
															s.handleGetTaskStatsRequest([2]string{
																args[0],
																args[1],
															}, elemIsEscaped, w, r)
														default:
							...
							case 'd': // Prefix: "dimensions"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										return r, true
									case "PUT":
										r.name = "CreateProjectDimensions"
										r.summary = "Modify Project Dimensions"
										r.operationID = "createProjectDimensions"
										r.pathPattern = "/htc/projects/{projectId}/dimensions"
										r.args = args
										r.count = 1
										return r, true
